...
export default function CmsAddProductPage() {
  ...
  // State untuk file (saat ini belum dipakai, tapi disiapkan)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newProduct = {
        ...
        startPrice,
        description,
        // Nanti akan tambahkan logika upload gambar
        images: ["/images/placeholders/default.jpg"] 
      };

      // Panggil POST /api/products
              ...
              <div className="card shadow-sm border-0">
                ...
                <div className="card-body p-4 text-center">
                  <div className="cms-upload-box">
                    <span className="text-muted"><FaUpload size={40} /></span>
                    <p className="mt-3 text-muted">Klik untuk upload foto (1:1)</p>
                  </div>
                  <small className="text-muted">(Fitur upload gambar akan ditambahkan nanti)</small>
                </div>
              </div>
            </div>
          </div>
